...
describe('binarySearchTree', () => {
  ...
  test('it should add a child to the right of a child node', () => {
    ...
    bst.insertNode(node2);
    let node3 = new BSTNode(65);
    bst.insertNode(node3);
    expect(rootNode.right.right.data).toEqual(65);
  })
  ...
  test('it should add a child to the right of a child node', () => {
    ...
    let node2 = new BSTNode(22);
    bst.insertNode(node2);
    let node3 = new BSTNode(25);
    bst.insertNode(node3);
    expect(rootNode.left.right.data).toEqual(25);
  })

  test('it should not add duplicates', () => {
    let bst = new BST();
    let rootNode = new BSTNode(36);
    bst.insertNode(rootNode);
    let node2 = new BSTNode(22);
    bst.insertNode(node2);
    let node3 = new BSTNode(22);
    bst.insertNode(node3);
    let bst2 = new BST();
    let rootNode2 = new BSTNode(36);
    bst2.insertNode(rootNode2);
    let node22 = new BSTNode(22);
    bst2.insertNode(node22);
    expect(rootNode.left.data).toEqual(rootNode2.left.data);
  })
